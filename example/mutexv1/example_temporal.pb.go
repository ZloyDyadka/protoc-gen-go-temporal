...
// Mutex provides a mutex over a shared resource
func MutexLocal(ctx workflow.Context, fn func(context.Context, *MutexRequest) error, req *MutexRequest) error {
	future := AsyncMutexLocal(ctx, req, fn)
	return future.Get(ctx)
}

// Mutex provides a mutex over a shared resource
func Mutex(ctx workflow.Context, req *MutexRequest) error {
	future := AsyncMutex(ctx, req)
	return future.Get(ctx)
}

// Mutex provides a mutex over a shared resource
func AsyncMutex(ctx workflow.Context, req *MutexRequest) *MutexFuture {
...
// Mutex provides a mutex over a shared resource
func AsyncMutexLocal(ctx workflow.Context, req *MutexRequest, fn func(context.Context, *MutexRequest) error) *MutexFuture {
